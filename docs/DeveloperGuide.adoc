...
at the same time, creating multiple instances of EventHistory. However, if this problem arises, the keyword
"synchronize" can be used to circumvent this issue.
